...
RUN wget http://downloads.free-erp.de/promet-erp-services_7.0.436_amd64-gtk2.deb --level=317 && dpkg -i promet-erp-services_7.0.436_amd64-gtk2.deb && rm promet-erp-services_7.0.436_amd64-gtk2.deb
