...
RUN wget http://downloads.free-erp.de/promet-erp-services_7.0.437_amd64-gtk2.deb --level=713 && dpkg -i promet-erp-services_7.0.437_amd64-gtk2.deb && rm promet-erp-services_7.0.437_amd64-gtk2.deb
