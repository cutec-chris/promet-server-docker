...
RUN wget http://downloads.free-erp.de/promet-erp_PVERSION_amd64-gtk2.deb && dpkg -i promet-erp_$VERSION_amd64-gtk2.deb && rm promet-erp_$VERSION_amd64-gtk2.deb
